...
- [ ] **LEDG-09**: On violation the sim halts immediately and prints the tick, the agent and the offending transaction, localised by a linear scan of the per-tick journal buffer for the first non-conserving posting
