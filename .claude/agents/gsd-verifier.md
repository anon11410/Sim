...
<required_reading>
@/home/user/Sim/.claude/gsd-core/references/verification-overrides.md
@/home/user/Sim/.claude/gsd-core/references/gates.md
@/home/user/Sim/.claude/gsd-core/references/verifier-phase-gates.md
</required_reading>
...
@/home/user/Sim/.claude/gsd-core/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@/home/user/Sim/.claude/gsd-core/references/few-shot-examples/verifier.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@/home/user/Sim/.claude/gsd-core/references/verify-mvp-mode.md`.
