...
<reference>
@/home/user/Sim/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `/home/user/Sim/.claude/gsd-core/references/user-profiling.md` to load:
