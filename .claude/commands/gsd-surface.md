...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/Sim/.claude/.gsd-surface.json`
(sibling to `/home/user/Sim/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/Sim/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/Sim/.claude/skills`).
...
`/home/user/Sim/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/Sim/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/Sim/.claude/.gsd-surface.json`
Install profile marker: `/home/user/Sim/.claude/.gsd-profile`
Skill dirs: `/home/user/Sim/.claude/skills/gsd-*/`
Engine module: `/home/user/Sim/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/Sim/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
