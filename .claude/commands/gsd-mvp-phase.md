...
<execution_context>
@/home/user/Sim/.claude/gsd-core/workflows/mvp-phase.md
...
<process>
Execute the mvp-phase workflow from @/home/user/Sim/.claude/gsd-core/workflows/mvp-phase.md end-to-end.
