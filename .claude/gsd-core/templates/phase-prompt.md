...
<!-- For checkpoint task examples and patterns, see @/home/user/Sim/.claude/gsd-core/references/checkpoints.md -->
...
See `/home/user/Sim/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `/home/user/Sim/.claude/gsd-core/templates/user-setup.md` for full schema and examples
